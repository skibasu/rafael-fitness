...
function my_scripts() {
    ...
    wp_enqueue_style( 'theme-style', get_stylesheet_directory_uri(). '/_dist/css/style.min.css', array() );
     wp_enqueue_style( 'slick-style',"//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css", array() );
   
   // wp_deregister_script( 'jquery' );

   wp_enqueue_script( 'jquery', get_template_directory_uri() . '/_dist/js/vendors/jQuery/jquery-3.4.1.min.js', array(), '3.4.1', false );
 ...
 wp_enqueue_script( 'slick', "//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js", array(), '1.8.1', true );
    wp_enqueue_script( 'theme-scripts', get_template_directory_uri() . '/_dist/js/app.min.js', array(), '1.0', true );
